...
const checkForSpam = function (message) {
  // твой код
  let textCheck = message.toLowerCase();
  return textCheck.includes('spam') || textCheck.includes('sale');

  // let messageForCheck = message.toLowerCase();
  // return messageForCheck.includes(`span`) || messageForCheck.includes(`sale`);
};
